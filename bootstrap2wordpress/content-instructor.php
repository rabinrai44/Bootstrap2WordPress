...
<section id="instructor">
    <div class="container">
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                       ...
                       <?php if( !empty($twitter_username) ) : ?>
                        ...
                        <a href="https://facebook.com/bradhussey/<?php echo $facebook_username; ?>" target="_blank" class="badge social facebook"><i class="fa fa-facebook"></i></a>

                        <?php endif; ?>

                         <?php if( !empty($google_plus_username) ) : ?>

                        <a href="https://plus.google.com/bradhussey/<?php echo $google_plus_username; ?> " target="_blank" class="badge social gplus"><i class="fa fa-google-plus"></i></a>
                        <?php endif; ?>
                    </div><!-- end col -->
                </div><!-- row -->
            ...
            <h3>The Numbers <small>They don't lies</small></h3>
